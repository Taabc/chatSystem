...
public class GroupTextPaneController {
    ...
    public static void add2(int groupId,
                            JTextPane inputJTpane,
...
//                    byte[] b = new byte[(int)newImage.()];
            ...
            clientMessage1.setGroup(group);
            clientMessage1.setOperate("sendGroupMessage");
